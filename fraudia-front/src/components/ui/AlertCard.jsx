export default function AlertCard({ alert }) {
  ...
  return (
    <div style={{ borderRadius: 8, padding: 12, background: 'var(--panel-bg)', display: 'flex', gap: 12, alignItems: 'center', borderLeft: `4px solid ${color}`, border: '1px solid var(--border)' }}>
